      ...
      <div className="flex items-center gap-4">
        {user ? (
          <>
            ...
            <div className="w-8 h-8 bg-[#334155] text-white rounded-full flex items-center justify-center font-semibold text-sm">
          ...
          <div className="flex items-center gap-3 pr-10">
            <Link
              to="/login"
              className="text-[#334155] border border-black font-medium hover:text-[#1e293b] transition-colors px-3 py-2 rounded-md"
            >
              Login
            </Link>
            <Link
              to="/signup"
              className="bg-[#334155] border border-black text-white font-medium hover:bg-[#1e293b] transition-colors px-4 py-2 rounded-md"
            >
              Sign Up
            </Link>
          </div>
